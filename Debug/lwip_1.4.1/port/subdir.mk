...
C_SRCS += \
../lwip_1.4.1/port/ethernetif.c \
../lwip_1.4.1/port/fsl_phy.c \
../lwip_1.4.1/port/sys_arch.c 

OBJS += \
./lwip_1.4.1/port/ethernetif.o \
./lwip_1.4.1/port/fsl_phy.o \
./lwip_1.4.1/port/sys_arch.o 

C_DEPS += \
./lwip_1.4.1/port/ethernetif.d \
./lwip_1.4.1/port/fsl_phy.d \
./lwip_1.4.1/port/sys_arch.d 


# Each subdirectory must supply rules for building sources it contributes
lwip_1.4.1/port/%.o: ../lwip_1.4.1/port/%.c
	@echo 'Building file: $<'
